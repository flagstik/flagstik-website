...
// Repeat team members to fill the marquee rows
const ROWS = [
  [...TEAM, ...TEAM, ...TEAM, ...TEAM],   // row 1 — forward
  [...TEAM, ...TEAM, ...TEAM, ...TEAM],   // row 2 — reverse
]
...
export default function Team() {
  return (
    <section id="team" style={{ minHeight: '100vh', padding: 'clamp(80px,10vw,160px) 0',
